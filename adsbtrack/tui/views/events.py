...
class EventsView(Vertical):
    ...
    def on_mount(self) -> None:
        # Column order mirrors the concept's event-feed grid: the two
        # identity columns (ICAO, CALLSIGN) sit together right after the
        # timestamp, with the EVENT pill and free-text SUMMARY trailing.
